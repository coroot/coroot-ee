...
create_uninstall() {
    UNINSTALL_SH=${BIN_DIR}/coroot-ee-uninstall.sh
...
systemctl stop coroot-ee
systemctl disable coroot-ee
systemctl reset-failed coroot-ee
...
rm -f ${SYSTEMD_DIR}/coroot-ee.service
rm -f ${SYSTEMD_DIR}/coroot-ee.service.env
...

{
    ...
    install coroot-ee "Coroot" "--data-dir=${DATA_DIR}"
